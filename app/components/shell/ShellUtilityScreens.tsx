...
const UPDATES = [
  {
    ...
    items: [
      ...
      "Temporada inteira simulada, com somente as finais alcançadas indo para a mesa",
      "Cinco titulares com posição livre e até três vagas reais no banco",
      "Venda de reservas e contratação sem substituição automática",
      "Formações aleatórias a cada gol e consulta visual na aba Time",
      "Trocas pausam relógio, CPU e a regra dos sete segundos",
      "Histórico coletivo, estatísticas refeitas e arquivo mundial ampliado",
