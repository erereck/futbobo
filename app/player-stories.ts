...
export const PLAYER_STORIES: PlayerStoryPreset[] = [
  {
    id: "open-book",
    icon: "○",
    title: "Uma página em branco",
    tagline: "Nenhum rótulo veio antes de você.",
    description: "Não existe sobrenome famoso, grande trauma ou profecia. A história nasce apenas do que acontecer na carreira — e isso também pode ser extraordinário.",
    promise: "Começo neutro e capítulos construídos inteiramente pelos acontecimentos do save.",
    tone: "blue",
    modifiers: {},
  },
  {
