  ...
  return (
    <div className="modal-backdrop android-install-backdrop" role="presentation">
      <section className="android-install-dialog" role="dialog" aria-modal="true" aria-labelledby="android-install-title">
        ...
        <div className="android-install-logo"><span>F</span><b>⚽</b></div>
        ...
        {!update && (
          <div className="android-install-benefits">
            <span><b>✓</b><strong>100% offline</strong><small>Depois de instalar, é só abrir e jogar.</small></span>
            <span><b>↓</b><strong>Atualizações avisadas</strong><small>Com internet, o app procura versões novas.</small></span>
            <span><b>◆</b><strong>Mesmo Futbobo</strong><small>Site e aplicativo usam exatamente o mesmo jogo.</small></span>
          </div>
        )}
        <button type="button" className="android-apk-download" onClick={onDownload}>
          <span>{update ? "Baixar atualização" : "Baixar APK offline"}</span><b>↓</b>
        </button>
        {!native && onWebInstall && (
